...
export const CHRON_TOOLBAR_WIDGET = 'chron-toolbar-widget';

export class ChronToolbarWidget extends WidgetComponent {
  static override styles = css`
    editor-toolbar {
      ...
      --affine-background-overlay-panel-color: var(--actual-background);
      --affine-v2-layer-background-overlayPanel: var(--actual-background);
      --affine-v2-layer-insideBorder-blackBorder: var(--base-300);
      --affine-v2-icon-primary: var(--base-content);
      --affine-primary-color: var(--base-content);
      --affine-brand-color: var(--base-content);
      --affine-background-error-color: rgba(239, 68, 68, 0.16);
      --affine-background-primary-color: rgba(59, 130, 246, 0.16);
      --affine-background-tertiary-color: var(--base-100);
      --affine-icon-color: var(--base-content);
      --affine-icon-secondary: var(--base-content-secondary);
      --affine-border-color: var(--base-300);
      --affine-divider-color: rgba(128, 128, 128, 0.22);
      --affine-text-primary-color: var(--base-content);
      --affine-hover-color: var(--base-200);
      --affine-hover-color-filled: var(--base-250);
      --editor-menu-action-icon-size: 16px;
      --affine-overlay-shadow:
    ...
    editor-toolbar[data-placement='inner'] {
      ...
      editor-menu-button {
        ...
        box-shadow: lch(0 0 0 / 0.022) 0px 2px 4px -1px;
